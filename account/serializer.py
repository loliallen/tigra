...
class GetUserSerializer(UserSerializer):
    ...
    class Meta:
        ...
        fields = User.REQUIRED_FIELDS + User.OTHER_FIELDS_TO_SEE + User.COMPUTED + (
            ...
            "password", djoser_settings.LOGIN_FIELD, djoser_settings.USER_ID_FIELD, "is_superuser", "phone_code", "phone_confirmed"  # выпилить когда фронт перестанет его использовать
        )
